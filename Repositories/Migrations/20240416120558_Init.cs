        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticleCreationDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ArticleModificationDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ArticlePriority = table.Column<int>(type: "int", nullable: false),
                    ArticleAuthorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TopicId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_AspNetUsers_ArticleAuthorId",
